...
/************************* PRINT PERCENT SIGN *************************/
/**
 * print_per - function to Print a percent sign
 * @types: List of arguments to the function
 * @buffer: Buffer to handle print
 * @flags:  Checks active flags in the arguments
 * @width: get width of arguments
 ...
 * @precision: Precision of the format specifier
 * @size: Size of the arguments
 * Return: Number of int chars to be printed
 */
...
/************************* PRINT BINARY *************************/
/**
 * print_b - function that Prints an unsigned number
 * @types: List of arguments to the function
 * @buffer: Buffer to handle print
 * @flags:  Checks active flags in the arguments
 * @width: get width.
 * @precision: Precision of the format specifier
 * @size: Size of the arguments
 * Return: Numbers of binary char to be printed.
 */
